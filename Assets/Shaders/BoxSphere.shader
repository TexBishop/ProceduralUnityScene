Shader "GrassShader"
{
    ...
    VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
    {
        ...
        float3 _Add_BA1BCDFE_Out_2;
        Unity_Add_float3(IN.ObjectSpacePosition, float3(-0.5, -0.5, 0.5), _Add_BA1BCDFE_Out_2);
        float3 _Normalize_EDEB16E4_Out_1;
        Unity_Normalize_float3(_Add_BA1BCDFE_Out_2, _Normalize_EDEB16E4_Out_1);
        float3 _Add_7D4685DE_Out_2;
        Unity_Add_float3(_Normalize_EDEB16E4_Out_1, float3(0.5, 0.5, -0.5), _Add_7D4685DE_Out_2);
        description.VertexPosition = _Add_7D4685DE_Out_2;
