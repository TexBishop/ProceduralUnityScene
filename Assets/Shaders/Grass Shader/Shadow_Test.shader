Shader "PBR Master"
{
    Properties
    {
        _TopColor("Top Color", Color) = (0.0005980707, 0.4716981, 0, 0.003921569)
        _BottomColor("Bottom Color", Color) = (0.000836957, 0.1132075, 0, 0.003921569)
...
SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
{
    ...
    float4 _Property_4F34D0DD_Out_0 = _BottomColor;
    float4 _Property_8BC92E1E_Out_0 = _TopColor;
    float _Split_7CDDE32B_R_1 = IN.ObjectSpacePosition[0];
    float _Split_7CDDE32B_G_2 = IN.ObjectSpacePosition[1];
    float _Split_7CDDE32B_B_3 = IN.ObjectSpacePosition[2];
    float _Split_7CDDE32B_A_4 = 0;
    float4 _Lerp_82ACDEC2_Out_3;
    Unity_Lerp_float4(_Property_4F34D0DD_Out_0, _Property_8BC92E1E_Out_0, (_Split_7CDDE32B_G_2.xxxx), _Lerp_82ACDEC2_Out_3);
    float _IsFrontFace_4C60FE14_Out_0 = max(0, IN.FaceSign);
    float3 _Multiply_C2FAE94D_Out_2;
    Unity_Multiply_float(float3(-1, -1, -1), IN.TangentSpaceNormal, _Multiply_C2FAE94D_Out_2);
    float3 _Branch_2BBBF6DE_Out_3;
    Unity_Branch_float3(_IsFrontFace_4C60FE14_Out_0, IN.TangentSpaceNormal, _Multiply_C2FAE94D_Out_2, _Branch_2BBBF6DE_Out_3);
    surface.Albedo = (_Lerp_82ACDEC2_Out_3.xyz);
    surface.Normal = _Branch_2BBBF6DE_Out_3;
